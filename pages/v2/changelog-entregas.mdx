  ...
  <Entry date="04 ago 2026" label="Melhoria" labelColor="#16A34A">
    ...
    <ChangeSection type="added">
      ...
      <ul style={{ margin: 0, paddingLeft: "20px", display: "flex", flexDirection: "column", gap: "8px" }}>
        ...
        <li><ParamBadge name="desejado" /> — endereço de destino: <code>endereco</code>, <code>bairro</code>, <code>cidade</code>, <code>estado</code>, <code>lat</code> e <code>lng</code>. Em entregas só vem preenchido quando há retorno; o destino de cada entrega fica nas paradas.</li>
    ...
    <div style={{
      ...
      <strong>Nota:</strong> os campos são apenas adicionados — nenhum campo existente mudou de nome, tipo ou posição. O endereço de origem vem em <code>coleta</code> para centrais que fazem somente entregas e em <code>partida</code> quando a central também faz corridas.
    </div>
  </Entry>
