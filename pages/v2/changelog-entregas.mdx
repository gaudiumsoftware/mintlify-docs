  ...
  <Entry date="24 set 2026" label="Novo" labelColor="#3b82f6">
    ...
    <ChangeSection type="added">
      <ul style={{ margin: 0, paddingLeft: "20px", display: "flex", flexDirection: "column", gap: "8px" }}>
        ...
        <li>Payload com <ParamBadge name="sender_type" /> (<code>DRIVER</code> ou <code>PASSENGER</code>), <ParamBadge name="request_id" /> da corrida e <ParamBadge name="links.request" />, além dos campos do webhook de mensagens. Detalhes na página <a href="/pages/v2/entregas/webhooks/sobre#webhook-de-mensagens-da-corrida">Sobre</a>.</li>
      </ul>
    </ChangeSection>
  </Entry>
