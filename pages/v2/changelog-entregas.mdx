...
<div style={{ maxWidth: "860px", margin: "0 auto", padding: "40px 20px 80px" }}>
  ...
  <Entry date="8 set 2026" label="Novo" labelColor="#3b82f6">
    ...
    <div style={{
      ...
      <strong>Requisitos da URL:</strong> <code>https</code> obrigatório, no máximo 500 caracteres e destino público — endereço interno (loopback, faixa privada ou link-local) é recusado com <code>400 URL_CONFIRMACAO_INVALIDA</code> (código 139). Não seguimos redirecionamento e o tempo limite é de 10 segundos. Se o seu sistema estiver indisponível, a entrega <strong>não</strong> é confirmada: a central ou a empresa libera a finalização pelo cadeado. A URL pode carregar o seu próprio token — ela é tratada como dado sensível e não aparece nas consultas da entrega. Aceita apenas na criação; a edição não altera a URL.
    </div>
  </Entry>
