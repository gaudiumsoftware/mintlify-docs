...
<div style={{ maxWidth: "860px", margin: "0 auto", padding: "40px 20px 80px" }}>
  ...
  <Entry date="31 jul 2026" label="Novo" labelColor="#3b82f6">
    ...
    <div style={{
      ...
      <strong>Nota:</strong> o parâmetro só tem efeito nas paradas cujo pedido tem código de confirmação — o que depende de a empresa ter <em>Solicitar código de confirmação de entrega</em> habilitado. Pedidos do iFood continuam exigindo o código independente do valor enviado, por ser regra da própria integração.
    </div>
  </Entry>
