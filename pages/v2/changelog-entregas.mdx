  ...
  <Entry date="29 set 2026" label="Novo" labelColor="#3b82f6">
    ...
    <ChangeSection type="added">
      <ul style={{ margin: 0, paddingLeft: "20px", display: "flex", flexDirection: "column", gap: "8px" }}>
        ...
        <li><ParamBadge name="data_hora_inicio" /> — início da entrega. Vem <code>null</code> enquanto não iniciou. Vem no mesmo formato e fuso de <ParamBadge name="data_hora_aceite" /> e <ParamBadge name="data_hora_finalizacao" /> (<code>AAAA-MM-DD HH:MM:SS</code>), e não como no recibo, onde o horário vem em ISO 8601, no fuso da central.</li>
