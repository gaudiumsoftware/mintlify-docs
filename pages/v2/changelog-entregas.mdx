  ...
  <Entry date="13 ago 2026" label="Novo" labelColor="#3b82f6">
    ...
    <ChangeSection type="added">
      <ul style={{ margin: 0, paddingLeft: "20px", display: "flex", flexDirection: "column", gap: "8px" }}>
        <li><ParamBadge name="exigir_codigo_confirmacao" /> — opcional. Envie <code>true</code> para tornar o código obrigatório nesta solicitação; omitir o campo ou enviar <code>false</code> mantém o que está configurado no cadastro da empresa (ou da central).</li>
      </ul>
    </ChangeSection>
    ...
    <div style={{
      ...
      <strong>Nota:</strong> são duas configurações distintas no cadastro da empresa. O parâmetro soma exigência sobre <em>Tornar os códigos de confirmação de entrega obrigatórios</em> — nunca a remove; a geração do código continua dependendo de <em>Solicitar código de confirmação de entrega dos pedidos</em> — em paradas sem código o parâmetro não tem efeito. Pedidos do iFood continuam exigindo o código independente do valor enviado, por ser regra da própria integração.
    </div>
  </Entry>
