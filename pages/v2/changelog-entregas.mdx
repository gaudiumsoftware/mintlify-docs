...
<div style={{ maxWidth: "860px", margin: "0 auto", padding: "40px 20px 80px" }}>
  ...
  <Entry date="29 set 2026" label="Novo" labelColor="#3b82f6">
    ...
    <ChangeSection type="added">
      <p style={{ marginBottom: "10px" }}>O retorno traz a lista das tarifas atuais da categoria — tarifas encerradas não são listadas. Cada item inclui:</p>
      <ul style={{ margin: 0, paddingLeft: "20px", display: "flex", flexDirection: "column", gap: "8px" }}>
        ...
        <li><ParamBadge name="valores_tabelados" /> — faixas de distância e valor, preenchidas apenas nos métodos de cálculo tabelados.</li>
      </ul>
    </ChangeSection>
  </Entry>
