...
<div style={{ maxWidth: "860px", margin: "0 auto", padding: "40px 20px 80px" }}>
  ...
  <Entry date="31 jul 2026" label="Novo" labelColor="#3b82f6">
    ...
    <p style={{ fontSize: "15px", opacity: 0.7, marginBottom: "20px", lineHeight: "1.6" }}>
      Agora é possível definir, por solicitação, se o condutor é obrigado a informar o código de
      confirmação para concluir a entrega, sobrepondo a configuração de obrigatoriedade do cadastro
      da empresa.
    </p>
    ...
    <ChangeSection type="added">
      <ul style={{ margin: 0, paddingLeft: "20px", display: "flex", flexDirection: "column", gap: "8px" }}>
        <li><ParamBadge name="exigir_codigo_confirmacao" /> — define se a inserção do código de confirmação é obrigatória. Opcional; se omitido, a solicitação segue a configuração da empresa (ou da central).</li>
      </ul>
    </ChangeSection>
    ...
    <div style={{ marginTop: "24px" }}>
      ...
      <ChangeSection type="added">
        <ul style={{ margin: 0, paddingLeft: "20px", display: "flex", flexDirection: "column", gap: "8px" }}>
          <li><ParamBadge name="exigir_codigo_confirmacao" /> — mesmo comportamento da criação de entrega. O valor informado é aplicado à solicitação gerada quando a programada dispara.</li>
        </ul>
      </ChangeSection>
    </div>
    ...
    <div style={{
      ...
      <strong>Nota:</strong> são duas configurações distintas no cadastro da empresa. O parâmetro sobrepõe apenas <em>Tornar os códigos de confirmação de entrega obrigatórios</em>; a geração do código continua dependendo de <em>Solicitar código de confirmação de entrega dos pedidos</em> — em paradas sem código o parâmetro não tem efeito. Pedidos do iFood continuam exigindo o código independente do valor enviado, por ser regra da própria integração.
    </div>
  </Entry>
