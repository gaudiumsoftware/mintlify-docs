...
<div style={{ maxWidth: "860px", margin: "0 auto", padding: "40px 20px 80px" }}>
  ...
  <Entry date="29 set 2026" label="Novo" labelColor="#3b82f6">
    ...
    <EndpointBadge method="GET" path="/api/v2/integracao/configuracoes/categorias/{id}/tarifas" href="/pages/v2/entregas/configuracoes/endpoint/get-categorias-tarifas" />
    ...
    <ChangeSection type="added">
      <p style={{ marginBottom: "10px" }}>O retorno traz a lista das tarifas atuais da categoria — já iniciadas e sem término ou com término futuro; tarifas encerradas ou futuras não são listadas. Cada item inclui:</p>
      <ul style={{ margin: 0, paddingLeft: "20px", display: "flex", flexDirection: "column", gap: "8px" }}>
        ...
        <li><ParamBadge name="data_inicio" /> e <ParamBadge name="data_fim" /> — vigência da tarifa; <ParamBadge name="data_fim" /> vem nulo quando a tarifa não tem término.</li>
