  ...
  <Entry date="04 ago 2026" label="Melhoria" labelColor="#16A34A">
    ...
    <ChangeSection type="added">
      ...
      <ul style={{ margin: 0, paddingLeft: "20px", display: "flex", flexDirection: "column", gap: "8px" }}>
        ...
        <li><ParamBadge name="nome_passageiro" /> — nome de quem solicitou, já devolvido na consulta de solicitação.</li>
    ...
    <div style={{
      ...
      <strong>Nota:</strong> os campos são apenas adicionados — nenhum campo existente mudou de nome, tipo ou posição. O endereço de origem vem em <code>coleta</code> para centrais que fazem somente entregas e em <code>partida</code> nas de corridas. O destino de cada entrega fica na respectiva parada, por isso a resposta de entregas não traz um endereço de destino da solicitação.
    </div>
  </Entry>
