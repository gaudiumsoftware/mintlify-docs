...
<div style={{ maxWidth: "860px", margin: "0 auto", padding: "40px 20px 80px" }}>
  ...
  <Entry date="04 ago 2026" label="Melhoria" labelColor="#16A34A">
    ...
    <ChangeSection type="added">
      ...
      <ul style={{ margin: 0, paddingLeft: "20px", display: "flex", flexDirection: "column", gap: "8px" }}>
        ...
        <li><ParamBadge name="desejado" /> — endereço de destino: <code>endereco</code>, <code>bairro</code>, <code>cidade</code>, <code>estado</code>, <code>lat</code> e <code>lng</code>. É onde fica o destino do passageiro nas corridas.</li>
        <li><ParamBadge name="paradas" /> — lista de paradas na ordem da corrida, cada uma com <code>id</code>, <code>ordem</code>, endereço completo, <code>numero_pedido</code>, <code>nome_cliente</code>, <code>telefone_cliente</code> e <code>observacao</code>.</li>
      </ul>
    </ChangeSection>
    ...
    <div style={{
      ...
      <strong>Nota:</strong> os campos são apenas adicionados — nenhum campo existente mudou de nome, tipo ou posição. Em corridas, <code>nome_cliente</code>, <code>telefone_cliente</code> e a <code>observacao</code> da parada vêm nulos, por serem dados de pedido. Já o <code>numero_pedido</code> pode vir preenchido: quando a parada não tem pedido vinculado, ele cai no identificador externo informado na própria parada.
    </div>
  </Entry>
