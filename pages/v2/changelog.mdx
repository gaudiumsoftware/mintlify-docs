...
<div style={{ maxWidth: "860px", margin: "0 auto", padding: "40px 20px 80px" }}>
  ...
  <Entry date="05 ago 2026" label="Novo" labelColor="#3b82f6">
    <h2 id="notificacoes-condutor" style={{ fontSize: "22px", fontWeight: "700", marginBottom: "6px", marginTop: 0 }}>
      Envio de notificação para condutores
    </h2>
    <p style={{ fontSize: "15px", opacity: 0.7, marginBottom: "20px", lineHeight: "1.6" }}>
      Novos endpoints para notificar condutores, em lote ou individualmente, com push comum e in-app messaging.
      Recebem a notificação os condutores da bandeira da sua chave de API (ou de suas filiais) que tenham
      aplicativo com token de notificação registrado.
    </p>
    ...
    <ChangeSection type="added">
      ...
      <ul style={{ margin: 0, paddingLeft: "20px", display: "flex", flexDirection: "column", gap: "8px" }}>
        <li><ParamBadge name="condutores" /> — obrigatório. Lista de identificadores dos condutores, limite de 1000 itens.</li>
    ...
    <div style={{ marginTop: "24px" }}>
      ...
      <ChangeSection type="added">
        <p style={{ marginBottom: "10px" }}>
          Mesmos campos do envio em lote, trocando <ParamBadge name="condutores" /> por <ParamBadge name="condutor_id" />.
        </p>
      </ChangeSection>
    </div>
    ...
    <div style={{
      ...
      <strong>Nota:</strong> informar <ParamBadge name="titulo_botao_redirecionamento" /> ou <ParamBadge name="link_redirecionamento" /> torna os dois obrigatórios. Quando nenhum condutor informado tem token de notificação registrado, a resposta é <code>404</code> e nada é enviado. Uma falha ao resolver o projeto de notificação do app do condutor devolve <code>503</code>.
    </div>
  </Entry>
