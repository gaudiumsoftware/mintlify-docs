...
<div style={{ maxWidth: "860px", margin: "0 auto", padding: "40px 20px 80px" }}>
  ...
  <Entry date="04 ago 2026" label="Novo" labelColor="#3b82f6">
    ...
    <div style={{
      ...
      <strong>Nota:</strong> os campos são apenas adicionados — nenhum campo existente mudou de nome, tipo ou posição. Em corridas, <code>numero_pedido</code>, <code>nome_cliente</code> e <code>telefone_cliente</code> das paradas vêm vazios, por serem dados de entrega.
    </div>
  </Entry>
