...
<div style={{ maxWidth: "860px", margin: "0 auto", padding: "40px 20px 80px" }}>
  ...
  <Entry date="22 set 2026" label="Novo" labelColor="#3b82f6">
    ...
    <EndpointBadge method="POST" path="/api/v2/integracao/mensagens/corridas" href="/pages/v2/referencia/mensagens/endpoint/post-corrida-passageiro" />

    <div style={{ marginTop: "24px" }}>
      <EndpointBadge method="GET" path="/api/v2/integracao/mensagens/corridas/{solicitacao_id}" href="/pages/v2/referencia/mensagens/endpoint/get-corrida-mensagens" />
    </div>
