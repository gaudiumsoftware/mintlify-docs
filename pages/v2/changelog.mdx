...
<div style={{ maxWidth: "860px", margin: "0 auto", padding: "40px 20px 80px" }}>
  ...
  <Entry date="28 jul 2026" label="Novo" labelColor="#3b82f6">
    ...
    <EndpointBadge method="POST" path="/api/v2/integracao/notificacoes/push/unico" href="/pages/v2/referencia/notificacao/endpoint/post-push-unico" />
    ...
    <div style={{ marginTop: "24px" }}>
      <EndpointBadge method="POST" path="/api/v2/integracao/notificacoes/in-app-messaging/unico" href="/pages/v2/referencia/notificacao/endpoint/post-in-app-messaging-unico" />
