...
<div style={{ maxWidth: "860px", margin: "0 auto", padding: "40px 20px 80px" }}>
  ...
  <Entry date="23 set 2026" label="Melhoria" labelColor="#16A34A">
    ...
    <p style={{ fontSize: "15px", opacity: 0.7, marginBottom: "20px", lineHeight: "1.6" }}>
      A criação de corrida aceita o campo <code>chat_ativo</code>. Quem exibe o chat da corrida no
      próprio sistema informa <code>true</code>, e o condutor passa a poder escrever primeiro, por
      exemplo para avisar que chegou. Sem o campo, o condutor continua escrevendo só depois da
      primeira mensagem do passageiro.
    </p>
  ...
  <Entry date="22 set 2026" label="Novo" labelColor="#3b82f6">
    ...
    <ChangeSection type="added">
      <ul style={{ margin: 0, paddingLeft: "20px", display: "flex", flexDirection: "column", gap: "8px" }}>
        ...
        <li>Quem abre a conversa é o parceiro: até a primeira mensagem, o condutor não vê a caixa de texto no app.</li>
