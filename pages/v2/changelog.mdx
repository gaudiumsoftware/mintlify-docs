---
title: "Novidades"
description: "Histórico de alterações e novidades da API de Integração V2"
---
...
<div style={{ maxWidth: "860px", margin: "0 auto", padding: "40px 20px 80px" }}>
  ...
  <div style={{ marginBottom: "56px" }}>
    <h1 style={{ fontSize: "40px", fontWeight: "800", marginBottom: "12px", letterSpacing: "-0.02em" }}>Changelog</h1>
    <p style={{ fontSize: "17px", opacity: 0.65, lineHeight: "1.6" }}>
      Acompanhe todas as novidades, melhorias e alterações na API de Integração V2. 
      Mantenha-se atualizado para aproveitar ao máximo os recursos disponíveis.
    </p>
  </div>
