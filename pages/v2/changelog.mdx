...
<div style={{ maxWidth: "860px", margin: "0 auto", padding: "40px 20px 80px" }}>
  ...
  <Entry date="05 ago 2026" label="Novo" labelColor="#3b82f6">
    ...
    <div style={{ marginTop: "24px" }}>
      ...
      <ChangeSection type="added">
        ...
        <ul style={{ margin: 0, paddingLeft: "20px", display: "flex", flexDirection: "column", gap: "8px" }}>
          ...
          <li><ParamBadge name="solicitacao_id" /> — opcional. Vincula a notificação a uma solicitação.</li>
    ...
    <div style={{
      ...
      <strong>Nota:</strong> informar <ParamBadge name="titulo_botao_redirecionamento" /> ou <ParamBadge name="link_redirecionamento" /> torna os dois obrigatórios. Quando nenhum condutor informado tem token de notificação registrado, a resposta é <code>404</code> e nada é enviado.
    </div>
  </Entry>
