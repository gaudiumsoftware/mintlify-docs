...
<div style={{ maxWidth: "860px", margin: "0 auto", padding: "40px 20px 80px" }}>
  ...
  <Entry date="14 jul 2026" label="Novo" labelColor="#3b82f6">
    ...
    <div style={{
      ...
      <strong>Nota:</strong> a foto só é gerada em buscas diretas por um único cliente (por <code>id</code>, <code>cpf</code>, <code>email</code> ou <code>telefone</code>); em listagens paginadas o campo retorna <code>null</code>.
    </div>
  </Entry>
