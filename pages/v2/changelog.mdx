...
<div style={{ maxWidth: "860px", margin: "0 auto", padding: "40px 20px 80px" }}>
  ...
  <Entry date="[DATA A DEFINIR — preencher com a data do merge do PR #9240 antes de publicar]" label="Melhoria" labelColor="#16A34A">
    ...
    <EndpointBadge method="PATCH" path="/api/v2/integracao/dinamicas/area/{id}" href="" />
    ...
    <ChangeSection type="changed">
      ...
      <ul style={{ margin: 0, paddingLeft: "20px", display: "flex", flexDirection: "column", gap: "8px" }}>
        ...
        <li><ParamBadge name="tipo_calculo" /> — forma de cálculo do fator: valor adicional fixo ou multiplicador.</li>
        <li><ParamBadge name="tipo_fator" /> — momento de aplicação do fator: na partida ou na parada.</li>
        <li><ParamBadge name="ativo" /> — comportamento inalterado, ativa ou desativa a dinâmica da área.</li>
      </ul>
    </ChangeSection>

    <div style={{ marginTop: "24px" }}>
      <EndpointBadge method="PATCH" path="/api/v2/integracao/dinamicas/area/{id}/vertices" href="" />
    </div>
    ...
    <div style={{
      ...
      <strong>Nota:</strong> a área é imutável depois de criada — alterar a geometria cria internamente uma NOVA área, copiando os demais atributos da original. A resposta traz um <code>id</code> de área diferente do informado na URL, que deve ser usado nas próximas requisições sobre essa área.
    </div>
  </Entry>
