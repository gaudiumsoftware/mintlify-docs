...
| In-app messaging (único) | `/api/v2/integracao/notificacoes/in-app-messaging/unico` | 200 * fator requisições por minuto |
| Push (único) | `/api/v2/integracao/notificacoes/push/unico` | 200 * fator requisições por minuto |
