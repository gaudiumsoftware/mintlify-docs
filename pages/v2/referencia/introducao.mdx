...
| Grupo | Paths | Limite |
| -------- | -------- | -------- |
| Posição de condutores livres | `/api/v2/integracao/condutores/posicoes` | 10 * fator requisições por minuto |
| Estimativas e empresas | `/api/v2/integracao/corridas/estimativas`<br />`/api/v2/integracao/corridas/programadas/estimativas`<br />`/api/v2/integracao/corridas/empresas/*` | 1000 * fator requisições por minuto |
| Créditos e documentos de condutores | `/api/v2/integracao/condutores/creditos/recargas`<br />`/api/v2/integracao/condutores/creditos/saques`<br />`/api/v2/integracao/condutores/documentos`<br />`/api/v2/integracao/condutores/requisitos-cadastro/documentos`<br />`/api/v2/integracao/condutores/areas-bloqueio/batch` | 1000 * fator requisições por minuto |
| Condutores | `/api/v2/integracao/condutores`<br />`/api/v2/integracao/condutores/*` | 80 * fator requisições por minuto |
| Programadas | `/api/v2/integracao/corridas/programadas`<br />`/api/v2/integracao/corridas/programadas/*` | 200 * fator requisições por minuto |
| Crítico | `/api/v2/integracao/corridas`<br />`/api/v2/integracao/corridas/*` | 800 * fator requisições por minuto |
| Categorias | `/api/v2/integracao/configuracoes/categorias/*` | 200 * fator requisições por minuto |
| Configurações (bandeira) | `/api/v2/integracao/configuracoes` | 200 * fator requisições por minuto |
| Saque automático | `/api/v2/integracao/configuracoes/saque-automatico/ativacao` | 50 * fator requisições por minuto |
| Dinâmica | `/api/v2/integracao/dinamicas*` | 200 * fator requisições por minuto |
| Notificações (in-app e push) | `/api/v2/integracao/notificacoes/in-app-messaging`<br />`/api/v2/integracao/notificacoes/push` | 100 * fator requisições por minuto |
| In-app messaging (individual) | `/api/v2/integracao/notificacoes/in-app-messaging/individual` | 200 * fator requisições por minuto |
| Push (individual) | `/api/v2/integracao/notificacoes/push/individual` | 200 * fator requisições por minuto |
| Notificações de condutor (in-app e push) | `/api/v2/integracao/notificacoes/condutor/in-app-messaging`<br />`/api/v2/integracao/notificacoes/condutor/push` | 100 * fator requisições por minuto |
| In-app messaging de condutor (individual) | `/api/v2/integracao/notificacoes/condutor/in-app-messaging/individual` | 200 * fator requisições por minuto |
| Push de condutor (individual) | `/api/v2/integracao/notificacoes/condutor/push/individual` | 200 * fator requisições por minuto |
| Cupons | `/api/v2/integracao/cupons` | 60 * fator requisições por minuto |
| Webhooks | `/api/v2/integracao/webhooks`<br />`/api/v2/integracao/webhooks/*` | 60 * fator requisições por minuto |
| Padrão | `/api/v2/integracao/*` | 1000 * fator requisições por minuto |
...
Quando o grupo tem mais de um limite de bloqueio, os headers refletem o mais restritivo (o de menor saldo).
