...
| Mensagens da corrida (envio) | `/api/v2/integracao/mensagens/corridas` | 900 * fator requisições por minuto, e no máximo 30 mensagens por corrida a cada 60 segundos. A leitura (`/api/v2/integracao/mensagens/corridas/*`) segue o limite Padrão. |
