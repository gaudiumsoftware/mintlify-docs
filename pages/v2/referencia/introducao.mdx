...
| Mensagens da corrida (envio) | `/api/v2/integracao/mensagens/corridas` | 900 * faixa requisições por minuto. A leitura (`/api/v2/integracao/mensagens/corridas/*`) segue o limite Padrão. |
