...
| Grupo | Paths | Limite |
| -------- | -------- | -------- |
| Estimativas e empresas | `/api/v2/integracao/entregas/estimativas`<br />`/api/v2/integracao/entregas/programadas/estimativas`<br />`/api/v2/integracao/entregas/empresas/*`<br />`/api/v2/integracao/entregas/bandeiras/areas-atuacao` | 1000 * fator requisições por minuto |
...
| Programadas | `/api/v2/integracao/entregas/programadas`<br />`/api/v2/integracao/entregas/programadas/*` | 200 * fator requisições por minuto |
| Crítico | `/api/v2/integracao/entregas`<br />`/api/v2/integracao/entregas/*` | 800 * fator requisições por minuto |
