...
| Grupo | Paths | Limite |
| -------- | -------- | -------- |
| Crítico Corridas | `/api/v2/integracao/corridas/*` | 800 * fator requisições por minuto |
| Crítico Entregas | `/api/v2/integracao/entregas/*` | 800 * fator requisições por minuto |
| Estimativas e empresas — Corridas | `/api/v2/integracao/corridas/estimativas`<br />`/api/v2/integracao/corridas/programadas/estimativas`<br />`/api/v2/integracao/corridas/empresas/*` | 1000 * fator requisições por minuto |
| Estimativas e empresas — Entregas | `/api/v2/integracao/entregas/estimativas`<br />`/api/v2/integracao/entregas/programadas/estimativas`<br />`/api/v2/integracao/entregas/empresas/*`<br />`/api/v2/integracao/entregas/bandeiras/areas-atuacao` | 1000 * fator requisições por minuto |
...
| Programadas — Corridas | `/api/v2/integracao/corridas/programadas`<br />`/api/v2/integracao/corridas/programadas/*` | 200 * fator requisições por minuto |
| Programadas — Entregas | `/api/v2/integracao/entregas/programadas`<br />`/api/v2/integracao/entregas/programadas/*` | 200 * fator requisições por minuto |
...
| In-app messaging | `/api/v2/integracao/notificacoes/in-app-messaging` | 100 * fator requisições por minuto |
