...
| Grupo | Paths | Limite |
| -------- | -------- | -------- |
| Crítico | `/api/integracao/solicitacao`<br />`/api/integracao/solicitacaoStatus` | 800 * fator requisições por minuto |
...
| Categorias | `/integracao/v1/categoria*` | Sem bloqueio configurado. O gateway registra log a partir de 10 * fator requisições por minuto. |
| Bandeiras | `/integracao/v1/bandeira*` | Sem bloqueio configurado. O gateway registra log a partir de 10 * fator requisições por minuto. |
...
| Notificações (in-app e push) | `/integracao/v1/notificacao/inAppMessaging`<br />`/integracao/v1/notificacao/push` | 20 * fator requisições por minuto |
