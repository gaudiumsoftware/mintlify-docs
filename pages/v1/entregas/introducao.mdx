...
<CardGroup cols={2}>
  <Card title="Entrega de refeições" icon="utensils" iconType="duotone">
    Levar a refeição de um restaurante até o cliente final.
  </Card>
  <Card title="Entrega de encomendas" icon="box" iconType="duotone">
    Levar encomendas de lojas ou centrais de distribuição até o cliente final.
  </Card>
</CardGroup>
