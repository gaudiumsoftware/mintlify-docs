...
| Créditos de condutor e empresa (recarga e saque) | `/api/integracao/recarregarCreditosCondutor`<br />`/api/integracao/sacarCreditosCondutor`<br />`/api/integracao/recarregarCreditosEmpresa`<br />`/api/integracao/sacarCreditosEmpresa` | `condutor.identificacao` ou `empresa.identificacao` no body | 5 por minuto por condutor ou empresa |
| Saldo e documentos de condutor e empresa | `/api/integracao/saldoCreditosCondutor`<br />`/api/integracao/obterDocumentosCadastroCondutor`<br />`/api/integracao/saldoCreditosEmpresa` | `condutor.identificacao` ou `empresa.identificacao` no body | 12 por minuto por condutor ou empresa |
